...
**Remote safety rule:** Never insert absolute local paths such as `/Users/.../.pi-paste/...` or `/root/.pi-paste/...`. Uploads must require a workspace and insert only `@.pi-paste/...`, otherwise remote agents cannot read the image.
