...
function closeCommandTerminalSoon(runtime, run) {
  ...
  const attempts = [0, 250, 1000, 2500];
...
function startTerminalCleanupPoll() {
  if (window.__screenshotPasteTerminalCleanupPoll) window.clearInterval(window.__screenshotPasteTerminalCleanupPoll);
  window.__screenshotPasteTerminalCleanupPoll = window.setInterval(() => {
    void closeExitedScreenshotPasteTerminals();
  }, 2000);
}
...
function cleanupPluginRuntime() {
  ...
  if (window.__screenshotPasteTerminalCleanupPoll) {
    window.clearInterval(window.__screenshotPasteTerminalCleanupPoll);
    window.__screenshotPasteTerminalCleanupPoll = null;
  }
}
